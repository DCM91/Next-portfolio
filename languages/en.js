export default {
    ...
    contact:{
      ...
      works: {
        ...
        Framematch: "FrameMatch is a real-time application built with Angular and Laravel, featuring JWT authentication, Socket.IO, and a microservices architecture deployed on Railway.",
        Tiendaonline: "An online store app built with IONIC, Vue.js, and MongoDB, with a modern mobile-first shopping experience.",
      },
    skills: {
      web: "WEB DEVELOPMENT",
