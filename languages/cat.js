...
contact:{
    ...
    works:{
      ...
      Framematch: "FrameMatch és una aplicació en temps real construïda amb Angular i Laravel, amb autenticació JWT, Socket.IO i arquitectura de microserveis desplegada a Railway.",
      Tiendaonline: "App de botiga online construïda amb IONIC, Vue.js i MongoDB, amb una experiència de compra mobile-first moderna.",
    },
    skills: {
