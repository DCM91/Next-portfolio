export default{
    ...
    about:{
      intro: "Full Stack Developer especializado en construir soluciones web completas. Mi enfoque combina precisión técnica con comunicación clara para crear productos que conectan personas y tecnología.",
    ...
    works:{
      ...
      Framematch: "FrameMatch es una aplicación en tiempo real construida con Angular y Laravel, con autenticación JWT, Socket.IO y arquitectura de microservicios desplegada en Railway.",
      Tiendaonline: "App de tienda online construida con IONIC, Vue.js y MongoDB, con una experiencia de compra mobile-first moderna.",
    },
    skills: {
      web: "DESARROLLO WEB",
