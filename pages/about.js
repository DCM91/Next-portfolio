    ...
    <Layout title="Dcm91Portfolio - About">
      <div className="grid h-fit  px-10 py-10">
        ...
        <div className="pt-4 flex  h-fit "> 
          <Image className="flex-1 mr-1 w-1/3" src={"/assets/clase esade.jpg"} width={250} height={250} alt="kakaka" />
          <div className="flex-2 w-2/3 h-100 flex align-middle justify-center">
            <p className="text-primary-focus text-base h-full align-middle text-right p-2 ">{t.about.basetext2}</p>
          </div>
        </div>       

        <div className="pt-4 flex h-fit "> 
          <div className="flex-1 w-2/3 h-100 flex align-middle justify-center">
            <p className="text-primary-focus text-base align-middle p-2 ">{t.about.basetext3}</p>
          </div>
        <Image className="flex-2 mr-1 w-1/3" src={"/assets/devworking.png"} width={225} height={225} alt="kakaka" />  
        </div>
      </div>   
    </Layout>
  )
